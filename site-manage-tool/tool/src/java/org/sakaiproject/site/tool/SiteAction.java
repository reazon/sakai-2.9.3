 ...
 * $Id: SiteAction.java 127227M 2013-11-06 11:28:19Z (local) $
 ***********************************************************************************
 *
...
public class SiteAction extends PagedResourceActionII {
	...
	private static org.sakaiproject.sitemanage.api.RubricService rubService = (org.sakaiproject.sitemanage.api.RubricService) ComponentManager
	.get(org.sakaiproject.sitemanage.api.RubricService.class);
	...
	private String buildContextForTemplate(String preIndex, int index, VelocityPortlet portlet,
		...
		case 29:
			...
			//DN 2013-04-22: if allow show irubric
			if(rubService.isShowiRubricLink()) {
				//Issue 53: DN 2012-08-14: check site have been attached rubric
				Boolean haveAttach = rubService.checkAttachRubric(site.getId());
				context.put("isHaveAttach", haveAttach);

			} else {
				context.put("isHaveAttach", Boolean.FALSE);
			}
					...
					if (StringUtils.trimToNull(params.getString("title")) == null) {
						...
						try {
							...
							try {
								...
								//Issue 53: DN 2012-08-13:copy rubric
								String rubric = params.getString("selectTooliRubric");
								if(rubService != null && rubric != null && rubric.equals("cpiRubric")) {
										rubService.transferRubric(oSiteId,site.getId());
								}
