...
function createLink(gradebookItemId) {
    ...
    var gbToolPlacementId = $('#gbToolPlacementId').val();
    
    var urlPage = gbToolPlacementId + "/iRubricLink.jsp?gradebookUid=" + gradebookUId + "&siteId=" + gradebookUId  ;
