...
asnn2gradeview.initIRubric = function(gradeObjectId,gradebookUid,siteId,studentId,gradebookPlacementId) {
    var refresh = function() {
      	var frame = document.createElement("iFrame");
	frame.id = "getGradeFrame";
	//var lnk = asnn2.makeIRubricUrlPrefix()+"/iRubricLink.jsp?".concat(
    var lnk = asnn2.makeIRubricUrlPrefix(gradebookPlacementId)+"/iRubricLink.jsp?".concat(
                        "p=gg&tool=asnn2"
    ...
    jQuery.getJSON(asnn2.makeIRubricUrlPrefix(gradebookPlacementId)+"/iRubricLink.jsp?p=ra&tool=asnn2&gradebookUid="+gradebookUid+"&siteId="+siteId+"&gradebookItemId="+gradeObjectId,function(data){
