        ...
        if (assignment.isGraded() && assignment.getGradebookItemId() != null &&
            ...
            if (gradebookItem != null && 
                ...
                if(externalGradebookLogic.isShowiRubricLink()){
                    ...
                    String gbToolPlacement = externalLogic.getToolPlacement(curContext, ExternalLogic.TOOL_ID_GRADEBOOK);
                    UIInitBlock.make(joint, "irubric-grade-details-init", "asnn2.initIRubricGradeDetails", new Object[] {gradebookItem.getGradebookItemId(), curContext, curContext, currentUser.getId(), gbToolPlacement});
                }
            }
        }
    }
